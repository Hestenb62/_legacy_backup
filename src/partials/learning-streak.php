    ...
    <div class="learning-streak-card">
        <div class="streak-header">
            ...
            <div class="streak-message-box">
                ...
                <p class="streak-subtitle" id="home-streak-sub">Practice daily to unlock mastery badges and keep your
                    streak alive.</p>
            </div>
            ...
            <div class="streak-goal-box">
                ...
                <div class="goal-progress-track" role="progressbar" aria-valuenow="0" aria-valuemin="0"
                    aria-valuemax="100" id="home-goal-track">
                    <div class="goal-progress-bar" id="home-goal-bar" style="width: 0%;"></div>
                </div>
            </div>

            <div class="streak-action-box">
                <button type="button" class="streak-action-btn"
                    onclick="window.toggleStudyTimer ? window.toggleStudyTimer() : null"
                    title="Start a focused study session (Alt+T)">
