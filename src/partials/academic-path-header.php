...
<div class="path-header-wrapper">
    ...
    <div class="path-tabs" role="tablist" aria-label="Filter learning paths">
        <button type="button" role="tab" aria-selected="true" class="path-tab active"
            onclick="setCategory(this, 'all', true)">
            <i class="fas fa-layer-group tab-icon-indigo"></i> All
        </button>
        <button type="button" role="tab" aria-selected="false" class="path-tab"
    ...
    <div class="path-search-group">
        ...
        <button id="clear-search" onclick="resetFilters()" class="path-search-clear hidden" aria-label="Clear Search"
            type="button">
