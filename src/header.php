...
<html lang="en" data-theme="light">
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?= assetVersion('/assets/css/components/command-palette.css') ?>" media="print"
            onload="this.media='all'">
        <noscript>
            <link rel="stylesheet" href="<?= assetVersion('/assets/css/components/command-palette.css') ?>">
        </noscript>
        <link rel="stylesheet" href="<?= assetVersion('/assets/css/components/shortcuts-modal.css') ?>" media="print"
            onload="this.media='all'">
        <noscript>
            <link rel="stylesheet" href="<?= assetVersion('/assets/css/components/shortcuts-modal.css') ?>">
        </noscript>
        <link rel="stylesheet" href="<?= assetVersion('/assets/css/components/quest-badges.css') ?>" media="print"
            onload="this.media='all'">
        <noscript>
            <link rel="stylesheet" href="<?= assetVersion('/assets/css/components/quest-badges.css') ?>">
        </noscript>
        <link rel="stylesheet" href="<?= assetVersion('/assets/css/components/accommodations.css') ?>" media="print"
            onload="this.media='all'">
        <noscript>
    ...
    <body>
        ...
        <div class="scroll-progress-container"
            style="position: fixed; top: 0; left: 0; width: 100%; height: 3px; z-index: 100;">
            <div class="scroll-progress-bar" id="scroll-bar"
                style="height: 100%; background: var(--color-primary); width: 0%;"></div>
        </div>
                ...
                <nav class="header-nav">
                    <a class="header-brand" href="/">
                        <img src="/assets/images/6791421e-7ca7-40bd-83d3-06a479bf7f36.png" alt="Hesten's Learning Logo"
                            width="38" height="38" class="header-brand-icon"
                            style="background: none; box-shadow: none; padding: 0;">
                        <span class="header-brand-text">Hesten's Learning</span>
                    </a>

                    <button id="nav-toggle" class="mobile-menu-btn" aria-label="Toggle navigation menu"
                    ...
                    <div class="header-nav-content" id="nav-content">
                        <div class="header-nav-links">
                            ...
                            <a href="/library/" class="nav-link"><i class="fas fa-book"
                                    style="margin-right: 0.25rem; opacity: 0.7;"></i> Library</a>

                            <!-- Expandable Resources Dropdown Menu -->
                            <div class="nav-dropdown-container" id="resources-dropdown-container">
                                <button type="button" class="nav-link nav-dropdown-btn" id="resources-dropdown-btn"
                                    aria-expanded="false" aria-haspopup="true" aria-controls="resources-dropdown-menu">
                                    <i class="fas fa-th-large" style="margin-right: 0.35rem; opacity: 0.75;"
                                        aria-hidden="true"></i>
                                    <span>Resources</span>
                                    <i class="fas fa-chevron-down nav-chevron" id="resources-nav-chevron"
                                        aria-hidden="true"></i>
                                </button>

                                <div class="nav-mega-dropdown" id="resources-dropdown-menu" role="menu"
                                    aria-labelledby="resources-dropdown-btn">
                                    <div class="nav-mega-grid">
                                        <!-- Column 1: Books & Library -->
                                        <div class="nav-mega-col">
                                            <span class="nav-mega-col-title">
                                                <i class="fas fa-book-open" style="color: #10b981;"></i> Books &amp;
                                                Library
                                            </span>
                                            <ul class="nav-mega-list">
                                                <li>
                                                    <a href="/library/index.php" class="nav-mega-item" role="menuitem">
                                                        ...
                                                        <div>
                                                            ...
                                                            <span class="item-desc">Browse full literature
                                                                collection</span>
                                                        </div>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="/library/read/?book=the-time-machine" class="nav-mega-item"
                                                        role="menuitem">
                                                ...
                                                <li>
                                                    <a href="/library/read/?book=frankenstein" class="nav-mega-item"
                                                        role="menuitem">
                                                ...
                                                <li>
                                                    <a href="/library/read/?book=the-american-yawp"
                                                        class="nav-mega-item" role="menuitem">
                                                        <i class="fas fa-landmark item-icon"
                                                ...
                                                <li>
                                                    <a href="/pages/grammar.php" class="nav-mega-item" role="menuitem">
                                                        <i class="fas fa-spell-check item-icon"
                                        ...
                                        <div class="nav-mega-col">
                                            ...
                                            <ul class="nav-mega-list">
                                                <li>
                                                    <a href="/assessment/diagnostic.php"
                                                        class="nav-mega-item featured-item" role="menuitem">
                                                ...
                                                <li>
                                                    <a href="/assessment/index.php#elem" class="nav-mega-item"
                                                        role="menuitem">
                                                ...
                                                <li>
                                                    <a href="/assessment/index.php#elem" class="nav-mega-item"
                                                        role="menuitem">
                                                        <i class="fas fa-pencil-ruler item-icon"
                                                            style="color: #3b82f6;"></i>
                                                        <div>
                                                            <span class="item-title">Elementary (Grades 1–5)</span>
                                                            <span class="item-desc">Math sprints &amp; reading
                                                                check</span>
                                                        </div>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="/assessment/index.php#middle" class="nav-mega-item"
                                                        role="menuitem">
                                                        <i class="fas fa-calculator item-icon"
                                                            style="color: #f97316;"></i>
                                                        <div>
                                                            <span class="item-title">Middle School (6–8)</span>
                                                            <span class="item-desc">Pre-algebra &amp; text
                                                                analysis</span>
                                                        </div>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="/assessment/index.php#high" class="nav-mega-item"
                                                        role="menuitem">
                                                        <i class="fas fa-graduation-cap item-icon"
                                        ...
                                        <div class="nav-mega-col">
                                            <span class="nav-mega-col-title">
                                                <i class="fas fa-layer-group" style="color: #8b5cf6;"></i> Curriculum
                                                Levels
                                            </span>
                                            <ul class="nav-mega-list">
                                                <li>
                                                ...
                                                <li>
                                                    <a href="/levels/ap-us-history.php" class="nav-mega-item"
                                                        role="menuitem">
                                                ...
                                                <li>
                                                    <a href="/levels/practice-ged.php" class="nav-mega-item"
                                                        role="menuitem">
                        ...
                        <div class="header-actions">
                            <button type="button" class="header-icon-action" id="btn-header-breathe"
                                onclick="if(window.HLSensory)window.HLSensory.open();"
                                title="Sensory Breathe &amp; Reset (Alt+B)"
                                aria-label="Sensory Breathe &amp; Reset (Alt+B)"
                                style="display:inline-flex; align-items:center; justify-content:center; width:2.25rem; height:2.25rem; border-radius:9999px; background:var(--color-bg-surface); border:1px solid var(--color-border); color:var(--color-text-main); cursor:pointer;">
                                <i class="fas fa-spa" style="color:#0ea5e9;"></i>
                            </button>
                            <button type="button" class="header-icon-action" id="btn-header-sound"
                                onclick="if(window.HLSound){const m=window.HLSound.toggleMute();this.innerHTML=m?'<i class=\'fas fa-volume-mute\' style=\'color:#94a3b8;\'></i>':'<i class=\'fas fa-volume-up\' style=\'color:#10b981;\'></i>';}"
                                title="Toggle Sound Feedback" aria-label="Toggle Sound Feedback"
                                style="display:inline-flex; align-items:center; justify-content:center; width:2.25rem; height:2.25rem; border-radius:9999px; background:var(--color-bg-surface); border:1px solid var(--color-border); color:var(--color-text-main); cursor:pointer;">
                                <i class="fas fa-volume-up" style="color:#10b981;"></i>
                            </button>

                            <div class="user-dropdown-container">
                                <button class="user-pill" id="user-pill-btn" aria-expanded="false" aria-haspopup="true"
                                    aria-controls="user-dropdown-menu">
                                    <img src="<?php echo htmlspecialchars($currentUser['avatar']); ?>" alt="User"
                                        class="user-avatar"
                                        onerror="this.src='https://ui-avatars.com/api/?name=User&background=random'">
                                    <div class="user-info">
                                        <span
                                            class="user-name"><?php echo htmlspecialchars($currentUser['name']); ?></span>
                                        <span
                                            class="user-role"><?php echo htmlspecialchars($currentUser['role']); ?></span>
                                    </div>
                                    <i class="fas fa-chevron-down user-chevron"></i>
                                </button>
                                <div class="user-dropdown-menu" id="user-dropdown-menu">
                                    <a href="#" class="dropdown-item"
                                        onclick="if(window.HLSensory)window.HLSensory.open();return false;"><i
                                            class="fas fa-spa" style="color:#0ea5e9;"></i> Breathe &amp; Reset</a>
                                    <div class="dropdown-divider"></div>
                                    <a href="/pages/profile.php" class="dropdown-item"><i class="fas fa-user"></i>
                                        Profile</a>
                                    <a href="/pages/settings.php" class="dropdown-item"><i class="fas fa-cog"></i>
                                        Settings</a>
                                    <div class="dropdown-divider"></div>
                                    <a href="#" class="dropdown-item text-danger"><i class="fas fa-sign-out-alt"></i>
                                        Logout</a>
                                </div>
                            </div>
        ...
        <div id="global-command-palette" class="cmd-palette-overlay" role="dialog" aria-modal="true"
