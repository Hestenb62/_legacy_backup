<?php
$pageTitle = '1984 Chapter 24 | Hesten\'s Learning';
$pageDescription = 'Chapter 24 of 1984 by George Orwell on Hesten\'s Learning e-library.';
...
<main id="main-content" class="library-main reader-main-layout">
    ...
    <article class="cdn-book-reader-container animate-reveal">
        <header class="reader-header">
            ...
            <h1 class="reader-title">1984 - Chapter 24</h1>
        ...
        <a href="/library/read/reader.php?book=1984&chapter=chapter-23" class="reader-chapter-nav-btn reader-chapter-nav-prev">
            <i class="fas fa-chevron-left"></i> Chapter 23
        </a>
        ...
        <a href="/library/read/reader.php?book=1984&chapter=chapter-25" class="reader-chapter-nav-btn reader-chapter-nav-next">
            Chapter 25 <i class="fas fa-chevron-right"></i>
        </a>
        </nav>
    </article>
</main>
