...
<main id="main-content" class="library-main reader-main-layout">
    ...
    <article class="cdn-book-reader-container animate-reveal">
        ...
        <a href="/library/read/index.php?book=1984&chapter=chapter-8" class="reader-chapter-nav-btn reader-chapter-nav-prev">
        ...
        <a href="/library/read/index.php?book=1984&chapter=chapter-10" class="reader-chapter-nav-btn reader-chapter-nav-next">
