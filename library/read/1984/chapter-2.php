<?php
$pageTitle = '1984 Chapter 2 | Hesten\'s Learning';
$pageDescription = 'Chapter 2 of 1984 by George Orwell on Hesten\'s Learning e-library.';
...
<main id="main-content" class="library-main reader-main-layout">
    ...
    <article class="cdn-book-reader-container animate-reveal">
        <header class="reader-header">
            ...
            <h1 class="reader-title">1984 - Chapter 2</h1>
...
<p>As he put his hand to the door-knob Winston saw that he had left the
        ...
        <a href="/library/read/reader.php?book=1984&chapter=chapter-1" class="reader-chapter-nav-btn reader-chapter-nav-prev">
            <i class="fas fa-chevron-left"></i> Chapter 1
        </a>
        ...
        <a href="/library/read/reader.php?book=1984&chapter=chapter-3" class="reader-chapter-nav-btn reader-chapter-nav-next">
            Chapter 3 <i class="fas fa-chevron-right"></i>
        </a>
        </nav>
    </article>
</main>
