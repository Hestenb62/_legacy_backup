...
<main id="main-content" class="library-main reader-main-layout">
    ...
    <article class="cdn-book-reader-container animate-reveal">
        ...
        <a href="index.php?book=1984&chapter=chapter-1" class="reader-chapter-nav-btn reader-chapter-nav-prev">
        ...
        <a href="index.php?book=1984&chapter=chapter-3" class="reader-chapter-nav-btn reader-chapter-nav-next">
