<?php
$pageTitle = '1984 Chapter 8 | Hesten\'s Learning';
$pageDescription = 'Chapter 8 of 1984 by George Orwell on Hesten\'s Learning e-library.';
...
<main id="main-content" class="library-main reader-main-layout">
    ...
    <article class="cdn-book-reader-container animate-reveal">
        <header class="reader-header">
            ...
            <h1 class="reader-title">1984 - Chapter 8</h1>
...
<p>From somewhere at the bottom of a passage the smell of roasting
        ...
        <a href="/library/read/reader.php?book=1984&chapter=chapter-7" class="reader-chapter-nav-btn reader-chapter-nav-prev">
            <i class="fas fa-chevron-left"></i> Chapter 7
        </a>
        ...
        <a href="/library/read/reader.php?book=1984&chapter=chapter-9" class="reader-chapter-nav-btn reader-chapter-nav-next">
            Chapter 9 <i class="fas fa-chevron-right"></i>
        </a>
        </nav>
    </article>
</main>
