<?php
$pageTitle = '1984 Chapter 25 | Hesten\'s Learning';
$pageDescription = 'Chapter 25 of 1984 by George Orwell on Hesten\'s Learning e-library.';
...
<main id="main-content" class="library-main reader-main-layout">
    ...
    <article class="cdn-book-reader-container animate-reveal">
        <header class="reader-header">
            ...
            <h1 class="reader-title">1984 - Chapter 25</h1>
...
<p>
        ...
        <a href="/library/read/reader.php?book=1984&chapter=chapter-24" class="reader-chapter-nav-btn reader-chapter-nav-prev">
            <i class="fas fa-chevron-left"></i> Chapter 24
        </a>
        ...
        <a href="/library/read/reader.php?book=1984&chapter=chapter-26" class="reader-chapter-nav-btn reader-chapter-nav-next">
