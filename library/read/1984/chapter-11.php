<?php
$pageTitle = '1984 Chapter 11 | Hesten\'s Learning';
$pageDescription = 'Chapter 11 of 1984 by George Orwell on Hesten\'s Learning e-library.';
...
<main id="main-content" class="library-main reader-main-layout">
    ...
    <article class="cdn-book-reader-container animate-reveal">
        <header class="reader-header">
            ...
            <h1 class="reader-title">1984 - Chapter 11</h1>
...
<p>
        ...
        <a href="/library/read/reader.php?book=1984&chapter=chapter-10" class="reader-chapter-nav-btn reader-chapter-nav-prev">
            <i class="fas fa-chevron-left"></i> Chapter 10
        </a>
        ...
        <a href="/library/read/reader.php?book=1984&chapter=chapter-12" class="reader-chapter-nav-btn reader-chapter-nav-next">
            Chapter 12 <i class="fas fa-chevron-right"></i>
        </a>
        </nav>
    </article>
</main>
