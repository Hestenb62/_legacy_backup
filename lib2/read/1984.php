    ...
    <article id="book-content" class="prose prose-lg dark:prose-invert max-w-none text-text-default">
      ...
      <div id="chapter-1" class="chapter-section active">
        ...
        <p>Winston turned round <span class="tooltip"><strong>abruptly</strong><span class="tooltiptext">Suddenly and
          ...
          packet marked VICTORY CIGARETTES and <span class="tooltip"><strong>incautiously</strong><span <<<<<<< Updated
              upstream class="tooltiptext">Without being careful</span></span> held it upright, whereupon the tobacco
          fell out on
          to the floor. With the next he was more successful. He went back to the living-room and sat down at a small
          table that stood to the left of the telescreen. From the table drawer he took out a penholder, a bottle of
          ink, and a thick, quarto-sized blank book with a red back and a marbled cover.
          =======
        ...
        <p>For some reason the telescreen in the living-room was in an unusual position. Instead of being placed, as was
          ...
          window. To one side of it there was a shallow <span class="tooltip"><strong>alcove</strong><span
              class="tooltiptext">A small recess opening off a larger room</span></span> in which Winston was now
          sitting, and which, when the flats were built, had probably been intended to hold bookshelves. By sitting in
          the alcove, and keeping well back, Winston was able to remain outside the range of the telescreen, so far as
          sight went. He could be heard, of course, but so long as he stayed in his present position he could not be
          seen. It was partly the unusual geography of the room that had suggested to him the thing that he was now
          about to do.</p>
        ...
        <p>But it had also been suggested by the book that he had just taken out of the drawer. It was a peculiarly
          ...
          He had seen it lying in the window of a <span class="tooltip"><strong>frowsy</strong><span
              class="tooltiptext">Scruffy and neglected in appearance</span></span> little junk-shop in a slummy quarter
          of the town (just what quarter he did not now remember) and had been stricken immediately by an overwhelming
          desire to possess it. Party members were supposed not to go into ordinary shops ('dealing on the free market',
          it was called), but the rule was not strictly kept, because there were various things, such as shoelaces and
          razor blades, which it was impossible to get hold of in any other way. He had given a quick glance up and down
          the street and then had slipped inside and bought the book for two dollars fifty. At the time he was not
          conscious of wanting it for any particular purpose. He had carried it guiltily home in his briefcase. Even
          with nothing written in it, it was a <span class="tooltip"><strong>compromising</strong><span
              class="tooltiptext">Making someone vulnerable to danger or suspicion</span></span> possession.</p>
        ...
        <p>The thing that he was about to do was to open a diary. This was not illegal (nothing was illegal, since there
          ...
          get the grease off. The pen was an <span class="tooltip"><strong>archaic</strong><span
              class="tooltiptext">Very old or old-fashioned</span></span> instrument, seldom used even for signatures,
          and he had <span class="tooltip"><strong>procured</strong><span class="tooltiptext">Obtained something,
              especially with care or effort</span></span> one, <span class="tooltip"><strong>furtively</strong><span
              class="tooltiptext">In a way that attempts to avoid notice or attention; secretively</span></span> and
          with some difficulty, simply because of a feeling that the beautiful creamy paper deserved to be written on
          with a real nib instead of being scratched with an ink-pencil. Actually he was not used to writing by hand.
          Apart from very short notes, it was usual to <span class="tooltip"><strong>dictate</strong><span
              class="tooltiptext">Say or read aloud words to be typed or written</span></span> everything into the
          speak-write which was of course impossible for his present purpose. He dipped the pen into the ink and then
          <span class="tooltip"><strong>faltered</strong><span class="tooltiptext">Start to lose strength or momentum;
              hesitate</span></span> for just a second. A tremor had gone through his bowels. To mark the paper was the
          <span class="tooltip"><strong>decisive</strong><span class="tooltiptext">Settling an issue; producing a
              definite result</span></span> act. In small clumsy letters he wrote:
        </p>

        <p>April 4th, 1984.</p>

        <p>He sat back. A sense of complete helplessness had descended upon him. To begin with, he did not know with any
          certainty that this was 1984. It must be round about that date, since he was fairly sure that his age was
          thirty-nine, and he believed that he had been born in 1944 or 1945; but it was never possible nowadays to pin
          down any date within a year or two.</p>

        <p>For whom, it suddenly occurred to him to wonder, was he writing this diary? For the future, for the unborn.
          His mind hovered for a moment round the doubtful date on the page, and then fetched up with a bump against the
          Newspeak word DOUBLETHINK. For the first time the <span class="tooltip"><strong>magnitude</strong><span
              class="tooltiptext">The great size or extent of something</span></span> of what he had undertaken came
          home to him. How could you communicate with the future? It was of its nature impossible. Either the future
          would resemble the present, in which case it would not listen to him: or it would be different from it, and
          his <span class="tooltip"><strong>predicament</strong><span class="tooltiptext">A difficult, unpleasant, or
              embarrassing situation</span></span> would be meaningless.</p>

        <p>For some time he sat gazing stupidly at the paper. The telescreen had changed over to <span
            class="tooltip"><strong>strident</strong><span class="tooltiptext">Loud and harsh; grating</span></span>
          military music. It was curious that he seemed not merely to have lost the power of expressing himself, but
          even to have forgotten what it was that he had originally intended to say. For weeks past he had been making
          ready for this moment, and it had never crossed his mind that anything would be needed except courage. The
          actual writing would be easy. All he had to do was to transfer to paper the <span
            class="tooltip"><strong>interminable</strong><span class="tooltiptext">Endless or apparently
              endless</span></span> restless <span class="tooltip"><strong>monologue</strong><span class="tooltiptext">A
              long speech by one person</span></span> that had been running inside his head, literally for years. At
          this moment, however, even the monologue had dried up. Moreover his varicose ulcer had begun itching
          unbearably. He dared not scratch it, because if he did so it always became inflamed. The seconds were ticking
          by. He was conscious of nothing except the blankness of the page in front of him, the itching of the skin
          above his ankle, the blaring of the music, and a slight booziness caused by the gin.</p>

        <p>Suddenly he began writing in sheer panic, only imperfectly aware of what he was setting down. His small but
          childish handwriting straggled up and down the page, shedding first its capital letters and finally even its
          full stops:</p>

        <p>April 4th, 1984. Last night to the flicks. All war films. One very good one of a ship full of <span
            class="tooltip"><strong>refugees</strong><span class="tooltiptext">People forced to leave their country to
              escape war, persecution, or natural disaster</span></span> being bombed somewhere in the Mediterranean.
          Audience much amused by shots of a great huge fat man trying to swim away with a helicopter after him, first
          you saw him <span class="tooltip"><strong>wallowing</strong><span class="tooltiptext">Rolling about or lying
              relaxed in mud or water</span></span> along in the water like a porpoise, then you saw him through the
          helicopters gunsights, then he was full of holes and the sea round him turned pink and he sank as suddenly as
          though the holes had let in the water, audience shouting with laughter when he sank. then you saw a lifeboat
          full of children with a helicopter hovering over it. there was a middle-aged woman might have been a jewess
          sitting up in the bow with a little boy about three years old in her arms. little boy screaming with fright
          and hiding his head between her breasts as if he was trying to burrow right into her and the woman putting her
          arms round him and comforting him although she was blue with fright herself, all the time covering him up as
          much as possible as if she thought her arms could keep the bullets off him. then the helicopter planted a 20
          kilo bomb in among them terrific flash and the boat went all to matchwood. then there was a wonderful shot of
          a child's arm going up up up right up into the air a helicopter with a camera in its nose must have followed
          it up and there was a lot of applause from the party seats but a woman down in the prole part of the house
          suddenly started kicking up a fuss and shouting they didnt oughter of showed it not in front of kids they
          didnt it aint right not in front of kids it aint until the police turned her turned her out i dont suppose
          anything happened to her nobody cares what the proles say typical prole reaction they never--</p>

        <p>Winston stopped writing, partly because he was suffering from cramp. He did not know what had made him pour
          out this stream of rubbish. But the curious thing was that while he was doing so a totally different memory
          had clarified itself in his mind, to the point where he almost felt equal to writing it down. It was, he now
          realized, because of this other incident that he had suddenly decided to come home and begin the diary today.
        </p>

        <p>It had happened that morning at the Ministry, if anything so <span
            class="tooltip"><strong>nebulous</strong><span class="tooltiptext">In the form of a cloud or haze; hazy or
              unclear</span></span> could be said to happen.</p>

        <p>It was nearly eleven hundred, and in the Records Department, where Winston worked, they were dragging the
          chairs out of the <span class="tooltip"><strong>cubicles</strong><span class="tooltiptext">Small
              partitioned-off areas of a room</span></span> and grouping them in the centre of the hall opposite the big
          ...
          enough to bring out the shapeliness of her hips. Winston had disliked her from the very first moment of seeing
          her. He knew the reason. It was because of the atmosphere of hockey-fields and cold baths and community hikes
          and general clean-mindedness which she managed to carry about with her. He disliked nearly all women, and
          especially the young and pretty ones. It was always the women, and above all the young ones, who were the most
          <span class="tooltip"><strong>bigoted</strong><span class="tooltiptext">Unreasonably attached to a belief,
              opinion, or faction</span></span> <span class="tooltip"><strong>adherents</strong><span
              class="tooltiptext">Someone who supports a particular party, person, or set of ideas</span></span> of the
          Party, the swallowers of slogans, the amateur spies and nosers-out of <span
            class="tooltip"><strong>unorthodoxy</strong><span class="tooltiptext">The quality of being contrary to what
              is usual, traditional, or accepted</span></span>. But this particular girl gave him the impression of
          being more dangerous than most. Once when they passed in the corridor she gave him a quick sidelong glance
          which seemed to pierce right into him and for a moment had filled him with black terror. The idea had even
          crossed his mind that she might be an agent of the Thought Police. That, it was true, was very unlikely.
          Still, he continued to feel a peculiar uneasiness, which had fear mixed up in it as well as <span
            class="tooltip"><strong>hostility</strong><span class="tooltiptext">Hostile behavior; unfriendliness or
              opposition</span></span>, whenever she was anywhere near him.
        </p>
        ...
        <p>The other person was a man named O'Brien, a member of the Inner Party and holder of some post so important
          ...
          <span class="tooltip"><strong>burly</strong><span class="tooltiptext">Large and strong; heavily
              built</span></span> man with a thick neck and a coarse, humorous, brutal face. In spite of his <span
            class="tooltip"><strong>formidable</strong><span class="tooltiptext">Inspiring fear or respect through being
              impressively large, powerful, intense, or capable</span></span> appearance he had a certain charm of
          manner. He had a trick of resettling his spectacles on his nose which was curiously <span
            class="tooltip"><strong>disarming</strong><span class="tooltiptext">Having the effect of allaying suspicion
              or hostility, especially through charm</span></span>-in some <span
            class="tooltip"><strong>indefinable</strong><span class="tooltiptext">Not able to be defined or described
              exactly</span></span> way, curiously civilized. It was a gesture which, if anyone had still thought in
          such terms, might have recalled an eighteenth-century nobleman offering his snuffbox. Winston had seen O'Brien
          perhaps a dozen times in almost as many years. He felt deeply drawn to him, and not solely because he was
          intrigued by the contrast between O'Brien's <span class="tooltip"><strong>urbane</strong><span
              class="tooltiptext">Suave, courteous, and refined in manner</span></span> manner and his prize-fighter's
          <span class="tooltip"><strong>physique</strong><span class="tooltiptext">The form, size, and development of a
              person's body</span></span>. Much more it was because of a secretly held belief-or perhaps not even a
          belief, merely a hope-that O'Brien's political <span class="tooltip"><strong>orthodoxy</strong><span
              class="tooltiptext">Authorized or generally accepted theory, doctrine, or practice</span></span> was not
          perfect. Something in his face suggested it <span class="tooltip"><strong>irresistibly</strong><span
              class="tooltiptext">In a way that is too attractive and tempting to be resisted</span></span>. And again,
          perhaps it was not even unorthodoxy that was written in his face, but simply intelligence. But at any rate he
          had the appearance of being a person that you could talk to if somehow you could cheat the telescreen and get
          him alone. Winston had never made the smallest effort to verify this guess: indeed, there was no way of doing
          so. At this moment O'Brien glanced at his wrist-watch, saw that it was nearly eleven hundred, and evidently
          decided to stay in the Records Department until the Two Minutes Hate was over. He took a chair in the same row
          as Winston, a couple of places away. A small, sandy-haired woman who worked in the next cubicle to Winston was
          between them. The girl with dark hair was sitting immediately behind.
        </p>

        <p>The next moment a <span class="tooltip"><strong>hideous</strong><span class="tooltiptext">Ugly or disgusting
              to look at</span></span>, grinding screech, as of some <span
            class="tooltip"><strong>monstrous</strong><span class="tooltiptext">Having the ugly or frightening
              appearance of a monster</span></span> machine running without oil, burst from the big telescreen at the
          end of the room. It was a noise that set one's teeth on edge and bristled the hair at the back of one's neck.
          The Hate had started.</p>

        <p>As usual, the face of Emmanuel Goldstein, the Enemy of the People, had flashed on to the screen. There were
          hisses here and there among the audience. The little sandy-haired woman gave a squeak of mingled fear and
          disgust. Goldstein was the <span class="tooltip"><strong>renegade</strong><span class="tooltiptext">A person
              who deserts and betrays an organization, country, or set of principles</span></span> and backslider who
          once, long ago (how long ago, nobody quite remembered), had been one of the leading figures of the Party,
          almost on a level with Big Brother himself, and then had engaged in counter-revolutionary activities, had been
          <span class="tooltip"><strong>condemned</strong><span class="tooltiptext">Sentenced to a particular
              punishment, especially death</span></span> to death, and had mysteriously escaped and disappeared. The
          programmes of the Two Minutes Hate varied from day to day, but there was none in which Goldstein was not the
          principal figure. He was the <span class="tooltip"><strong>primal</strong><span class="tooltiptext">Essential;
              fundamental</span></span> traitor, the earliest <span class="tooltip"><strong>defiler</strong><span
              class="tooltiptext">Someone who ruins or spoils something</span></span> of the Party's purity. All
          subsequent crimes against the Party, all <span class="tooltip"><strong>treacheries</strong><span
              class="tooltiptext">Betrayals of trust; deceptive action or nature</span></span>, acts of <span
            class="tooltip"><strong>sabotage</strong><span class="tooltiptext">Deliberately destroy, damage, or obstruct
              something</span></span>, <span class="tooltip"><strong>heresies</strong><span class="tooltiptext">Beliefs
              or opinions contrary to orthodox religious doctrine or accepted beliefs</span></span>, <span
            class="tooltip"><strong>deviations</strong><span class="tooltiptext">The action of departing from an
              established course or accepted standard</span></span>, sprang directly out of his teaching. Somewhere or
          other he was still alive and hatching his <span class="tooltip"><strong>conspiracies</strong><span
              class="tooltiptext">Secret plans by a group to do something unlawful or harmful</span></span>: perhaps
          somewhere beyond the sea, under the protection of his foreign paymasters, perhaps even-so it was occasionally
          rumoured-in some hiding-place in Oceania itself.
        </p>

        <p>Winston's diaphragm was <span class="tooltip"><strong>constricted</strong><span class="tooltiptext">Make
              narrower, especially by encircling pressure</span></span>. He could never see the face of Goldstein
          without a painful mixture of emotions. It was a lean Jewish face, with a great fuzzy aureole of white hair and
          a small goatee beard-a clever face, and yet somehow <span class="tooltip"><strong>inherently</strong><span
              class="tooltiptext">In a permanent, essential, or characteristic way</span></span> <span
            class="tooltip"><strong>despicable</strong><span class="tooltiptext">Deserving hatred and
              contempt</span></span>, with a kind of senile silliness in the long thin nose, near the end of which a
          pair of spectacles was perched. It resembled the face of a sheep, and the voice, too, had a sheep-like
          quality. Goldstein was delivering his usual <span class="tooltip"><strong>venomous</strong><span
              class="tooltiptext">Full of malice or spite</span></span> attack upon the <span
            class="tooltip"><strong>doctrines</strong><span class="tooltiptext">A belief or set of beliefs held and
              taught by a Church, political party, or other group</span></span> of the Party-an attack so exaggerated
          and <span class="tooltip"><strong>perverse</strong><span class="tooltiptext">Showing a deliberate and
              obstinate desire to behave in a way that is unreasonable or unacceptable</span></span> that a child should
          have been able to see through it, and yet just <span class="tooltip"><strong>plausible</strong><span
              class="tooltiptext">Seeming reasonable or probable</span></span> enough to fill one with an alarmed
          feeling that other people, less level-headed than oneself, might be taken in by it. He was abusing Big
          Brother, he was <span class="tooltip"><strong>denouncing</strong><span class="tooltiptext">Publicly declare to
              be wrong or evil</span></span> the dictatorship of the Party, he was demanding the immediate conclusion of
          peace with Eurasia, he was <span class="tooltip"><strong>advocating</strong><span class="tooltiptext">Publicly
              recommend or support</span></span> freedom of speech, freedom of the Press, freedom of assembly, freedom
          of thought, he was crying hysterically that the revolution had been betrayed-and all this in rapid <span
            class="tooltip"><strong>polysyllabic</strong><span class="tooltiptext">Having more than one
              syllable</span></span> speech which was a sort of parody of the habitual style of the orators of the
          Party, and even contained Newspeak words: more Newspeak words, indeed, than any Party member would normally
          use in real life. And all the while, lest one should be in any doubt as to the reality which Goldstein's <span
            class="tooltip"><strong>specious</strong><span class="tooltiptext">Superficially plausible, but actually
              wrong</span></span> claptrap covered, behind his head on the telescreen there marched the endless columns
          of the Eurasian army-row after row of solid-looking men with expressionless Asiatic faces, who swam up to the
          surface of the screen and vanished, to be replaced by others exactly similar. The dull rhythmic tramp of the
          soldiers' boots formed the background to Goldstein's bleating voice.</p>

        <p>Before the Hate had proceeded for thirty seconds, uncontrollable exclamations of rage were breaking out from
          half the people in the room. The self-satisfied sheep-like face on the screen, and the terrifying power of the
          Eurasian army behind it, were too much to be borne: besides, the sight or even the thought of Goldstein
          produced fear and anger automatically. He was an object of hatred more constant than either Eurasia or
          Eastasia, since when Oceania was at war with one of these Powers it was generally at peace with the other. But
          what was strange was that although Goldstein was hated and despised by everybody, although every day and a
          thousand times a day, on platforms, on the telescreen, in newspapers, in books, his theories were <span
            class="tooltip"><strong>refuted</strong><span class="tooltiptext">Prove a statement or theory to be wrong or
              false; disprove</span></span>, smashed, ridiculed, held up to the general gaze for the pitiful rubbish
          that they were-in spite of all this, his influence never seemed to grow less. Always there were fresh dupes
          waiting to be seduced by him. A day never passed when spies and <span
            class="tooltip"><strong>saboteurs</strong><span class="tooltiptext">A person who engages in
              sabotage</span></span> acting under his directions were not unmasked by the Thought Police. He was the
          commander of a vast shadowy army, an underground network of conspirators dedicated to the overthrow of the
          State. The Brotherhood, its name was supposed to be. There were also whispered stories of a terrible book, a
          <span class="tooltip"><strong>compendium</strong><span class="tooltiptext">A collection of concise but
              detailed information about a particular subject</span></span> of all the heresies, of which Goldstein was
          the author and which circulated <span class="tooltip"><strong>clandestinely</strong><span
              class="tooltiptext">In a secretive and illicit way</span></span> here and there. It was a book without a
          title. People referred to it, if at all, simply as THE BOOK. But one knew of such things only through vague
          rumours. Neither the Brotherhood nor THE BOOK was a subject that any ordinary Party member would mention if
          there was a way of avoiding it.
        </p>

        <p>In its second minute the Hate rose to a <span class="tooltip"><strong>frenzy</strong><span
              class="tooltiptext">A state or period of uncontrolled excitement or wild behavior</span></span>. People
          were leaping up and down in their places and shouting at the tops of their voices in an effort to drown the
          maddening bleating voice that came from the screen. The little sandy-haired woman had turned bright pink, and
          her mouth was opening and shutting like that of a landed fish. Even O'Brien's heavy face was flushed. He was
          sitting very straight in his chair, his powerful chest swelling and quivering as though he were standing up to
          the assault of a wave. The dark-haired girl behind Winston had begun crying out 'Swine! Swine! Swine!' and
          suddenly she picked up a heavy Newspeak dictionary and flung it at the screen. It struck Goldstein's nose and
          bounced off; the voice continued <span class="tooltip"><strong>inexorably</strong><span class="tooltiptext">In
              a way that is impossible to stop or prevent</span></span>.</p>

        <p>In a <span class="tooltip"><strong>lucid</strong><span class="tooltiptext">Expressed clearly; easy to
              understand or thinking clearly</span></span> moment Winston found that he was shouting with the others and
          kicking his heel violently against the rung of his chair. The horrible thing about the Two Minutes Hate was
          not that one was obliged to act a part, but, on the contrary, that it was impossible to avoid joining in.
          Within thirty seconds any <span class="tooltip"><strong>pretence</strong><span class="tooltiptext">An attempt
              to make something that is not the case appear true</span></span> was always unnecessary. A hideous <span
            class="tooltip"><strong>ecstasy</strong><span class="tooltiptext">An overwhelming feeling of great happiness
              or joyful excitement</span></span> of fear and <span class="tooltip"><strong>vindictiveness</strong><span
              class="tooltiptext">A strong desire to get back at someone</span></span>, a desire to kill, to torture, to
          smash faces in with a sledge-hammer, seemed to flow through the whole group of people like an electric
          current, turning one even against one's will into a <span class="tooltip"><strong>grimacing</strong><span
              class="tooltiptext">Making an ugly, twisted expression on a person's face</span></span>, screaming
          lunatic. And yet the rage that one felt was an abstract, undirected emotion which could be switched from one
          object to another like the flame of a blowlamp. Thus, at one moment Winston's hatred was not turned against
          Goldstein at all, but, on the contrary, against Big Brother, the Party, and the Thought Police; and at such
          moments his heart went out to the lonely, <span class="tooltip"><strong>derided</strong><span
              class="tooltiptext">Express contempt for; ridicule</span></span> <span
            class="tooltip"><strong>heretic</strong><span class="tooltiptext">A person holding an opinion at odds with
              what is generally accepted</span></span> on the screen, sole guardian of truth and sanity in a world of
          lies. And yet the very next instant he was at one with the people about him, and all that was said of
          Goldstein seemed to him to be true. At those moments his secret loathing of Big Brother changed into
          adoration, and Big Brother seemed to tower up, an <span class="tooltip"><strong>invincible</strong><span
              class="tooltiptext">Too powerful to be defeated or overcome</span></span>, fearless protector, standing
          like a rock against the hordes of Asia, and Goldstein, in spite of his isolation, his helplessness, and the
          doubt that hung about his very existence, seemed like some sinister enchanter, capable by the mere power of
          his voice of wrecking the structure of civilization.</p>

        <p>It was even possible, at moments, to switch one's hatred this way or that by a voluntary act. Suddenly, by
          ...
          beautiful <span class="tooltip"><strong>hallucinations</strong><span class="tooltiptext">Experiences involving
              the apparent perception of something not present</span></span> flashed through his mind. He would flog her
          to death with a rubber truncheon. He would tie her naked to a stake and shoot her full of arrows like Saint
          Sebastian. He would <span class="tooltip"><strong>ravish</strong><span class="tooltiptext">Seize and carry off
              by force</span></span> her and cut her throat at the moment of climax. Better than before, moreover, he
          realized WHY it was that he hated her. He hated her because she was young and pretty and sexless, because he
          wanted to go to bed with her and would never do so, because round her sweet <span
            class="tooltip"><strong>supple</strong><span class="tooltiptext">Bending and moving easily and gracefully;
              flexible</span></span> waist, which seemed to ask you to encircle it with your arm, there was only the
          <span class="tooltip"><strong>odious</strong><span class="tooltiptext">Extremely unpleasant;
              repulsive</span></span> scarlet sash, aggressive symbol of <span
            class="tooltip"><strong>chastity</strong><span class="tooltiptext">The state or practice of refraining from
              sexual intercourse</span></span>.
        </p>
        ...
        <p>The Hate rose to its climax. The voice of Goldstein had become an actual sheep's bleat, and for an instant
          ...
          surface of the screen, so that some of the people in the front row actually <span
            class="tooltip"><strong>flinched</strong><span class="tooltiptext">Make a quick, nervous movement of the
              face or body as an instinctive reaction</span></span> backwards in their seats. But in the same moment,
          drawing a deep sigh of relief from everybody, the <span class="tooltip"><strong>hostile</strong><span
              class="tooltiptext">Unfriendly; antagonistic</span></span> figure melted into the face of Big Brother,
          black-haired, black-moustachio'd, full of power and mysterious calm, and so vast that it almost filled up the
          screen. Nobody heard what Big Brother was saying. It was merely a few words of encouragement, the sort of
          words that are uttered in the <span class="tooltip"><strong>din</strong><span class="tooltiptext">A loud,
              unpleasant, and prolonged noise</span></span> of battle, not distinguishable individually but restoring
          confidence by the fact of being spoken. Then the face of Big Brother faded away again, and instead the three
          slogans of the Party stood out in bold capitals:</p>
        ...
        <p>But the face of Big Brother seemed to persist for several seconds on the screen, as though the impact that it
          ...
          herself forward over the back of the chair in front of her. With a <span
            class="tooltip"><strong>tremulous</strong><span class="tooltiptext">Shaking or quivering
              slightly</span></span> murmur that sounded like 'My Saviour!' she extended her arms towards the screen.
          Then she buried her face in her hands. It was apparent that she was uttering a prayer.</p>

        <p>At this moment the entire group of people broke into a deep, slow, rhythmical chant of 'B-B!...B-B!'-over and
          over again, very slowly, with a long pause between the first 'B' and the second-a heavy, murmurous sound,
          somehow curiously savage, in the background of which one seemed to hear the stamp of naked feet and the
          throbbing of tom-toms. For perhaps as much as thirty seconds they kept it up. It was a refrain that was often
          heard in moments of overwhelming emotion. Partly it was a sort of hymn to the wisdom and majesty of Big
          Brother, but still more it was an act of self-hypnosis, a deliberate drowning of consciousness by means of
          rhythmic noise. Winston's entrails seemed to grow cold. In the Two Minutes Hate he could not help sharing in
          the general <span class="tooltip"><strong>delirium</strong><span class="tooltiptext">An acutely disturbed
              state of mind</span></span>, but this sub-human chanting of 'B-B!...B-B!' always filled him with horror.
          Of course he chanted with the rest: it was impossible to do otherwise. To <span
            class="tooltip"><strong>dissemble</strong><span class="tooltiptext">Conceal one's true motives, feelings, or
              beliefs</span></span> your feelings, to control your face, to do what everyone else was doing, was an
          instinctive reaction. But there was a space of a couple of seconds during which the expression of his eyes
          might conceivably have betrayed him. And it was exactly at this moment that the significant thing happened-if,
          indeed, it did happen.</p>

        <p>Momentarily he caught O'Brien's eye. O'Brien had stood up. He had taken off his spectacles and was in the act
          of resettling them on his nose with his characteristic gesture. But there was a fraction of a second when
          their eyes met, and for as long as it took to happen Winston knew-yes, he KNEW!-that O'Brien was thinking the
          same thing as himself. An unmistakable message had passed. It was as though their two minds had opened and the
          thoughts were flowing from one into the other through their eyes. 'I am with you,' O'Brien seemed to be saying
          to him. 'I know precisely what you are feeling. I know all about your <span
            class="tooltip"><strong>contempt</strong><span class="tooltiptext">The feeling that a person or a thing is
              beneath consideration, worthless, or deserving scorn</span></span>, your hatred, your disgust. But don't
          worry, I am on your side!' And then the flash of intelligence was gone, and O'Brien's face was as <span
            class="tooltip"><strong>inscrutable</strong><span class="tooltiptext">Impossible to understand or
              interpret</span></span> as everybody else's.</p>

        <p>That was all, and he was already uncertain whether it had happened. Such incidents never had any sequel. All
          ...
          only <span class="tooltip"><strong>fleeting</strong><span class="tooltiptext">Lasting for a very short
              time</span></span> glimpses that might mean anything or nothing: snatches of overheard conversation, faint
          scribbles on lavatory walls-once, even, when two strangers met, a small movement of the hand which had looked
          as though it might be a signal of recognition. It was all guesswork: very likely he had imagined everything.
          He had gone back to his cubicle without looking at O'Brien again. The idea of following up their momentary
          contact hardly crossed his mind. It would have been inconceivably dangerous even if he had known how to set
          about doing it. For a second, two seconds, they had exchanged an <span
            class="tooltip"><strong>equivocal</strong><span class="tooltiptext">Open to more than one interpretation;
              ambiguous</span></span> glance, and that was the end of the story.</p>
        ...
        <p>His eyes re-focused on the page. He discovered that while he sat helplessly <span
            class="tooltip"><strong>musing</strong><span class="tooltiptext">A period of reflection or
              thought</span></span> he had also been writing, as though by automatic action. And it was no longer the
          same cramped, awkward handwriting as before. His pen had slid <span
            class="tooltip"><strong>voluptuously</strong><span class="tooltiptext">In a way that is characterized by
              luxury or sensual pleasure</span></span> over the smooth paper, printing in large neat capitals-</p>

        <p class="font-mono text-center my-4 font-bold tracking-widest leading-loose">DOWN WITH BIG BROTHER<br>DOWN WITH
          BIG BROTHER<br>DOWN WITH BIG BROTHER<br>DOWN WITH BIG BROTHER<br>DOWN WITH BIG BROTHER</p>
        ...
        <p>He could not help feeling a <span class="tooltip"><strong>twinge</strong><span class="tooltiptext">A sudden,
              sharp localized pain or pang of emotion</span></span> of panic. It was absurd, since the writing of those
          particular words was not more dangerous than the initial act of opening the diary, but for a moment he was
          tempted to tear out the spoiled pages and abandon the enterprise altogether.</p>

        <p>He did not do so, however, because he knew that it was useless. Whether he wrote DOWN WITH BIG BROTHER, or
          whether he <span class="tooltip"><strong>refrained</strong><span class="tooltiptext">Stop oneself from doing
              something</span></span> from writing it, made no difference. Whether he went on with the diary, or whether
          he did not go on with it, made no difference. The Thought Police would get him just the same. He had
          committed-would still have committed, even if he had never set pen to paper-the essential crime that contained
          all others in itself. Thoughtcrime, they called it. Thoughtcrime was not a thing that could be concealed for
          ever. You might dodge successfully for a while, even for years, but sooner or later they were bound to get
          you.</p>

        <p>It was always at night-the arrests <span class="tooltip"><strong>invariably</strong><span
              class="tooltiptext">In every case or on every occasion; always</span></span> happened at night. The sudden
          jerk out of sleep, the rough hand shaking your shoulder, the lights glaring in your eyes, the ring of hard
          faces round the bed. In the vast majority of cases there was no trial, no report of the arrest. People simply
          disappeared, always during the night. Your name was removed from the registers, every record of everything you
          had ever done was wiped out, your one-time existence was denied and then forgotten. You were abolished, <span
            class="tooltip"><strong>annihilated</strong><span class="tooltiptext">Destroy utterly;
              obliterate</span></span>: VAPORIZED was the usual word.</p>

        <p>For a moment he was seized by a kind of <span class="tooltip"><strong>hysteria</strong><span
              class="tooltiptext">Exaggerated or uncontrollable emotion or excitement</span></span>. He began writing in
          a hurried untidy scrawl:</p>

        <p class="italic text-text-secondary">theyll shoot me i don't care theyll shoot me in the back of the neck i
          dont care down with big brother they always shoot you in the back of the neck i dont care down with big
          brother--</p>

        <p>He sat back in his chair, slightly ashamed of himself, and laid down the pen. The next moment he started
          violently. There was a knocking at the door.</p>

        <p>Already! He sat as still as a mouse, in the <span class="tooltip"><strong>futile</strong><span
              class="tooltiptext">Incapable of producing any useful result; pointless</span></span> hope that whoever it
          was might go away after a single attempt. But no, the knocking was repeated. The worst thing of all would be
          to delay. His heart was thumping like a drum, but his face, from long habit, was probably expressionless. He
          got up and moved heavily towards the door.</p>
      ...
      <div id="chapter-2" class="chapter-section">
        ...
        <p>As he put his hand to the door-knob Winston saw that he had left the
        ...
        <p>The Parsons' flat was bigger than Winston's, and dingy in a different
        ...
        <p>'It's the children,' said Mrs Parsons, casting a half-apprehensive glance
          at the door. 'They haven't been out today. And of course----'</p>

        <p>She had a habit of breaking off her sentences in the middle. The kitchen
        ...
        <p>'Of course if Tom was home he'd put it right in a moment,' she said.
          'He loves anything like that. He's ever so good with his hands, Tom is.'</p>

        <p>Parsons was Winston's fellow-employee at the Ministry of Truth. He was
          ...
          hikes, <span class="tooltip"><strong>spontaneous</strong><span class="tooltiptext">Performed or occurring as a
              result of a sudden inner impulse or inclination</span></span> demonstrations, savings campaigns, and
          voluntary
        ...
        <p>'Have you got a spanner?' said Winston, fiddling with the nut on the
          angle-joint.</p>

        <p>'A spanner,' said Mrs Parsons, immediately becoming invertebrate. 'I don't
          know, I'm sure. Perhaps the children----'</p>

        <p>There was a trampling of boots and another blast on the comb as the
        ...
        <p>A handsome, tough-looking boy of nine had popped up from behind the table
        ...
        <p>'You're a traitor!' yelled the boy. 'You're a thought-criminal! You're a
          Eurasian spy! I'll shoot you, I'll vaporize you, I'll send you to the salt
          mines!'</p>

        <p>Suddenly they were both leaping round him, shouting 'Traitor!' and
        ...
        <p>Mrs Parsons' eyes flitted nervously from Winston to the children, and back
        ...
        <p>'They do get so noisy,' she said. 'They're disappointed because they
        ...
        <p>'Want to see the hanging! Want to see the hanging!' chanted the little
          girl, still capering round.</p>

        <p>Some Eurasian prisoners, guilty of war crimes, were to be hanged in the
        ...
        <p>'Goldstein!' bellowed the boy as the door closed on him. But what most
          struck Winston was the look of helpless fright on the woman's greyish face.</p>

        <p>Back in the flat he stepped quickly past the telescreen and sat down at the
        ...
        <p>With those children, he thought, that wretched woman must lead a life of
          ...
          and yet this produced in them no tendency whatever to <span class="tooltip"><strong>rebel</strong><span
              class="tooltiptext">A person who rises in opposition or armed resistance against an established government
              or ruler</span></span> against the
        ...
        <p>The sting of the catapult bullet had worn off. He picked up his pen
        ...
        <p>Years ago--how long was it? Seven years it must be--he had dreamed that he
        ...
        <p>Winston had never been able to feel sure--even after this morning's flash
        ...
        <p>The voice from the telescreen paused. A trumpet call, clear and beautiful,
          floated into the stagnant air. The voice continued raspingly:</p>

        <p>'Attention! Your attention, please! A newsflash has this moment arrived
        ...
        <p>Bad news coming, thought Winston. And sure enough, following on a gory
        ...
        <p>Winston belched again. The gin was wearing off, leaving a deflated feeling.
        ...
        <p>'Oceania, 'tis for thee' gave way to lighter music. Winston walked over to
        ...
        <p>Down in the street the wind flapped the torn poster to and fro, and the
          word INGSOC fitfully appeared and vanished. Ingsoc. The sacred principles
          of Ingsoc. Newspeak, doublethink, the <span class="tooltip"><strong>mutability</strong><span
              class="tooltiptext">Liability or tendency to change</span></span> of the past. He felt as
        ...
        <p>He took a twenty-five cent piece out of his pocket. There, too, in tiny
        ...
        <p>The sun had shifted round, and the myriad windows of the Ministry of Truth,
        ...
        <p>The telescreen struck fourteen. He must leave in ten minutes. He had to be
          back at work by fourteen-thirty.</p>

        <p>Curiously, the chiming of the hour seemed to have put new heart into him.
        ...
        <p>To the future or to the past, to a time when thought is free, when men
        ...
        <p>He was already dead, he reflected. It seemed to him that it was only now,
        ...
        <p>Now he had recognized himself as a dead man it became important to stay
        ...
        <p>He put the diary away in the drawer. It was quite useless to think of
      ...
      <div id="chapter-3" class="chapter-section">
        ...
        <p>He must, he thought, have been ten or eleven years old when his mother had
        ...
        <p>At this moment his mother was sitting in some place deep down beneath him,
        ...
        <p>He could not remember what had happened, but he knew in his dream that in
        ...
        <p>Suddenly he was standing on short springy turf, on a summer evening when
        ...
        <p>The girl with dark hair was coming towards them across the field. With
        ...
        <p>The telescreen was giving forth an ear-splitting whistle which continued on
        ...
        <p>'Thirty to forty group!' yapped a piercing female voice. 'Thirty to forty
          group! Take your places, please. Thirties to forties!'</p>

        <p>Winston sprang to attention in front of the telescreen, upon which the
          image of a youngish woman, scrawny but muscular, dressed in tunic and
          gym-shoes, had already appeared.</p>

        <p>'Arms bending and stretching!' she rapped out. 'Take your time by me. ONE,
          two, three, four! ONE, two, three, four! Come on, comrades, put a bit of
          life into it! ONE, two, three four! ONE two, three, four!...'</p>

        <p>The pain of the coughing fit had not quite driven out of Winston's mind the
        ...
        <p>Winston could not definitely remember a time when his country had not been
        ...
        <p>There were people sitting all over the stone-flagged floor, and other
        ...
        <p>'We didn't ought to 'ave trusted 'em. I said so, Ma, didn't I? That's what
          comes of trusting 'em. I said so all along. We didn't ought to 'ave trusted
          the buggers.'</p>

        <p>But which buggers they didn't ought to have trusted Winston could not now
          remember.</p>

        <p>Since about that time, war had been literally continuous, though strictly
        ...
        <p>The frightening thing, he reflected for the ten thousandth time as he
        ...
        <p>The Party said that Oceania had never been in alliance with Eurasia. He,
        ...
        <p>Winston sank his arms to his sides and slowly refilled his lungs with air.
        ...
        <p>The instructress had called them to attention again. 'And now let's see
          which of us can touch our toes!' she said enthusiastically. 'Right over
          from the hips, please, comrades. ONE-two! ONE-two!...'</p>

        <p>Winston loathed this exercise, which sent shooting pains all the way from
        ...
        <p>'Smith!' screamed the shrewish voice from the telescreen. '6079 Smith W.!
        ...
        <p>A sudden hot sweat had broken out all over Winston's body. His face
        ...
        <p>'THERE, comrades! THAT'S how I want to see you doing it. Watch me again.
      ...
      <div id="chapter-4" class="chapter-section">
        ...
        <p>With the deep, unconscious sigh which not even the nearness of the
        ...
        <p>In the walls of the cubicle there were three orifices. To the right of the
        ...
        <p>Winston examined the four slips of paper which he had unrolled. Each
        ...
        <p>times 3.12.83 reporting bb dayorder doubleplusungood refs unpersons rewrite
          fullwise upsub antefiling</p>

        <p>With a faint feeling of satisfaction Winston laid the fourth message aside.
          ...
          mean some <span class="tooltip"><strong>tedious</strong><span class="tooltiptext">Too long, slow, or dull:
              tiresome or monotonous</span></span> wading through lists of figures.</p>

        <p>Winston dialled 'back numbers' on the telescreen and called for the
        ...
        <p>As soon as Winston had dealt with each of the messages, he clipped his
        ...
        <p>What happened in the unseen labyrinth to which the pneumatic tubes led, he
        ...
        <p>But actually, he thought as he re-adjusted the Ministry of Plenty's
        ...
        <p>Winston glanced across the hall. In the corresponding cubicle on the other
        ...
        <p>Winston hardly knew Tillotson, and had no idea what work he was employed
        ...
        <p>And the Records Department, after all, was itself only a single branch of
        ...
        <p>Three messages had slid out of the pneumatic tube while Winston was
        ...
        <p>Winston's greatest pleasure in life was in his work. Most of it was a
          <span class="tooltip"><strong>tedious</strong><span class="tooltiptext">Too long, slow, or dull: tiresome or
              monotonous</span></span> routine, but included in it there were also jobs so difficult and
        ...
        <p>times 3.12.83 reporting bb dayorder doubleplusungood refs unpersons
          rewrite fullwise upsub antefiling</p>

        <p>In Oldspeak (or standard English) this might be rendered:</p>

        <p>The reporting of Big Brother's Order for the Day in 'The Times' of December
          3rd 1983 is extremely unsatisfactory and makes references to non-existent
          persons. Rewrite it in full and submit your draft to higher authority
          before filing.</p>

        <p>Winston read through the offending article. Big Brother's Order for the
        ...
        <p>Three months later FFCC had suddenly been dissolved with no reasons given.
        ...
        <p>Winston stroked his nose gently with a paper-clip. In the cubicle
        ...
        <p>Winston did not know why Withers had been disgraced. Perhaps it was for
          ...
          been suspected of <span class="tooltip"><strong>heretical</strong><span class="tooltiptext">Believing in or
              practicing religious heresy; holding an opinion at odds with what is generally accepted</span></span>
          tendencies. Or perhaps--what was likeliest of
        ...
        <p>He might turn the speech into the usual denunciation of traitors and
        ...
        <p>Winston thought for a moment, then pulled the speakwrite towards him and
        ...
        <p>At the age of three Comrade Ogilvy had refused all toys except a drum, a
          ...
          and all--an end, said Big Brother, which it was impossible to <span
            class="tooltip"><strong>contemplate</strong><span class="tooltiptext">To look thoughtfully for a long time
              at</span></span>
        ...
        <p>Winston debated with himself whether to award Comrade Ogilvy the Order of
          Conspicuous Merit: in the end he decided against it because of the
          unnecessary cross-referencing that it would entail.</p>

        <p>Once again he glanced at his rival in the opposite cubicle. Something
          ...
          but he felt a <span class="tooltip"><strong>profound</strong><span class="tooltiptext">Very great or
              intense</span></span> conviction that it would be his own. Comrade Ogilvy,
      ...
      <div id="chapter-5" class="chapter-section">
        ...
        <p>In the low-ceilinged canteen, deep underground, the lunch queue jerked
        ...
        <p>He turned round. It was his friend Syme, who worked in the Research
        ...
        <p>'Not one!' said Winston with a sort of guilty haste. 'I've tried all over
          the place. They don't exist any longer.'</p>

        <p>Everyone kept asking you for razor blades. Actually he had two unused ones
        ...
        <p>The queue gave another jerk forward. As they halted he turned and faced
        ...
        <p>'I was working,' said Winston indifferently. 'I shall see it on the
          flicks, I suppose.'</p>

        <p>'A very inadequate substitute,' said Syme.</p>

        <p>His mocking eyes roved over Winston's face. 'I know you,' the eyes seemed
          ...
          <span class="tooltip"><strong>orthodox</strong><span class="tooltiptext">Conforming to what is generally or
              traditionally accepted as right or true</span></span>. He would talk with a disagreeable gloating
          satisfaction of
        ...
        <p>'It was a good hanging,' said Syme reminiscently. 'I think it spoils it
        ...
        <p>Winston and Syme pushed their trays beneath the grille. On to each was
        ...
        <p>'There's a table over there, under that telescreen,' said Syme. 'Let's pick
          up a gin on the way.'</p>

        <p>The gin was served out to them in handleless china mugs. They threaded
        ...
        <p>'How is the Dictionary getting on?' said Winston, raising his voice to
          overcome the noise.</p>

        <p>'Slowly,' said Syme. 'I'm on the adjectives. It's fascinating.'</p>

        <p>He had brightened up immediately at the mention of Newspeak. He pushed his
        ...
        <p>'The Eleventh Edition is the definitive edition,' he said. 'We're getting
          ...
          <span class="tooltip"><strong>obsolete</strong><span class="tooltiptext">No longer produced or used; out of
              date</span></span> before the year 2050.'
        </p>

        <p>He bit hungrily into his bread and swallowed a couple of mouthfuls, then
        ...
        <p>'It's a beautiful thing, the destruction of words. Of course the great
        ...
        <p>A sort of <span class="tooltip"><strong>vapid</strong><span class="tooltiptext">Offering nothing that is
              stimulating or challenging</span></span> eagerness flitted across Winston's face at the mention of
          Big Brother. Nevertheless Syme immediately detected a certain lack of
          enthusiasm.</p>

        <p>'You haven't a real appreciation of Newspeak, Winston,' he said almost
        ...
        <p>Winston did know that, of course. He smiled, sympathetically he hoped, not
          trusting himself to speak. Syme bit off another fragment of the
          dark-coloured bread, chewed it briefly, and went on:</p>

        <p>'Don't you see that the whole aim of Newspeak is to narrow the range of
        ...
        <p>It had been on the tip of his tongue to say 'Except the proles,' but he
        ...
        <p>'The proles are not human beings,' he said carelessly. 'By 2050--earlier,
        ...
        <p>One of these days, thought Winston with sudden deep conviction, Syme will
        ...
        <p>Winston had finished his bread and cheese. He turned a little sideways
        ...
        <p>Syme had fallen silent for a moment, and with the handle of his spoon was
        ...
        <p>'There is a word in Newspeak,' said Syme, 'I don't know whether you know
        ...
        <p>Unquestionably Syme will be vaporized, Winston thought again. He thought
        ...
        <p>Something in the tone of his voice seemed to add, 'that bloody fool'.
        ...
        <p>'Look at him working away in the lunch hour,' said Parsons, nudging
        ...
        <p>'Which sub is that?' said Winston, automatically feeling for money. About
        ...
        <p>'For Hate Week. You know--the house-by-house fund. I'm treasurer for our
        ...
        <p>Winston found and handed over two creased and filthy notes, which Parsons
          entered in a small notebook, in the neat handwriting of the illiterate.</p>

        <p>'By the way, old boy,' he said. 'I hear that little beggar of mine let fly
        ...
        <p>'I think he was a little upset at not going to the execution,' said
          Winston.</p>

        <p>'Ah, well--what I mean to say, shows the right spirit, doesn't it?
        ...
        <p>'What did they do that for?' said Winston, somewhat taken aback. Parsons
          went on triumphantly:</p>

        <p>'My kid made sure he was some kind of enemy agent--might have been dropped
        ...
        <p>'Ah, that I couldn't say, of course. But I wouldn't be altogether surprised
        ...
        <p>As though in confirmation of this, a trumpet call floated from the
        ...
        <p>'Comrades!' cried an eager youthful voice. 'Attention, comrades! We have
          ...
          year. All over Oceania this morning there were irrepressible <span
            class="tooltip"><strong>spontaneous</strong><span class="tooltiptext">Performed or occurring as a result of
              a sudden inner impulse or inclination</span></span>
        ...
        <p>The phrase 'our new, happy life' recurred several times. It had been a
        ...
        <p>The fabulous statistics continued to pour out of the telescreen. As
          ...
          discomfort and dirt and scarcity, the <span class="tooltip"><strong>interminable</strong><span
              class="tooltiptext">Endless (often used hyperbolically)</span></span> winters, the stickiness
        ...
        <p>He looked round the canteen again. Nearly everyone was ugly, and would
        ...
        <p>The announcement from the Ministry of Plenty ended on another trumpet call
        ...
        <p>'The Ministry of Plenty's certainly done a good job this year,' he said
        ...
        <p>'Not one,' said Winston. 'I've been using the same blade for six weeks
          myself.'</p>
        ...
        <p>The quacking voice from the next table, temporarily silenced during the
        ...
        <p>At this moment he was dragged out of his reverie with a violent jerk. The
        ...
        <p>The sweat started out on Winston's backbone. A horrible pang of terror
          ...
          when there was no <span class="tooltip"><strong>apparent</strong><span class="tooltiptext">Clearly visible or
              understood; obvious</span></span> need to do so. Quite likely her real object had
          been to listen to him and make sure whether he was shouting loudly enough.</p>

        <p>His earlier thought returned to him: probably she was not actually a member
          ...
          your face (to look <span class="tooltip"><strong>incredulous</strong><span class="tooltiptext">Unwilling or
              unable to believe something</span></span> when a victory was announced, for example)
          was itself a punishable offence. There was even a word for it in Newspeak:
          FACECRIME, it was called.</p>

        <p>The girl had turned her back on him again. Perhaps after all she was not
        ...
        <p>'Did I ever tell you, old boy,' he said, chuckling round the stem of his
        ...
        <p>At this moment the telescreen let out a piercing whistle. It was the
      ...
      <div id="chapter-6" class="chapter-section">
        ...
        <p>It was three years ago. It was on a dark evening, in a narrow
        ...
        <p>For the moment it was too difficult to go on. He shut his eyes and pressed
        ...
        <p>Your worst enemy, he reflected, was your own nervous system. At any moment
        ...
        <p>I went with her through the doorway and across a backyard into a
          basement kitchen. There was a bed against the wall, and a lamp on the
          table, turned down very low. She----</p>

        <p>His teeth were set on edge. He would have liked to spit. Simultaneously
        ...
        <p>When he had gone with that woman it had been his first lapse in two years
        ...
        <p>The aim of the Party was not merely to prevent men and women from forming
        ...
        <p>He thought again of Katharine. It must be nine, ten--nearly eleven years
        ...
        <p>Katharine was a tall, fair-haired girl, very straight, with splendid
        ...
        <p>As soon as he touched her she seemed to wince and stiffen. To embrace her
        ...
        <p>Winston sighed inaudibly. He picked up his pen again and
          wrote:</p>

        <p>She threw herself down on the bed, and at once, without any kind of
          preliminary in the most coarse, horrible way you can imagine, pulled up
          her skirt. I----</p>

        <p>He saw himself standing there in the dim lamplight, with the smell of bugs
        ...
        <p>After the darkness the feeble light of the paraffin lamp had seemed very
        ...
        <p>It had got to be written down, it had got to be confessed. What he had
        ...
        <p>When I saw her in the light she was quite an old woman, fifty years old
          at least. But I went ahead and did it just the same.</p>

        <p>He pressed his fingers against his eyelids again. He had written it down
      ...
      <div id="chapter-7" class="chapter-section">
        ...
        <p>If there was hope, it MUST lie in the proles, because only there in those
        ...
        <p>He remembered how once he had been walking down a crowded street when a
        ...
        <p>Until they become conscious they will never <span class="tooltip"><strong>rebel</strong><span
              class="tooltiptext">A person who rises in opposition or armed resistance against an established government
              or ruler</span></span>, and until after they
          have rebelled they cannot become conscious.</p>

        <p>That, he reflected, might almost have been a transcription from one of the
        ...
        <p>Winston reached down and cautiously scratched his varicose ulcer. It
        ...
        <p>In the old days (it ran), before the glorious Revolution, London was
        ...
        <p>But he knew the rest of the catalogue. There would be mention of the
        ...
        <p>How could you tell how much of it was lies? It MIGHT be true that the
        ...
        <p>He reached down and scratched his ankle again. Day and night the
        ...
        <p>Everything faded into mist. The past was erased, the erasure was forgotten,
        ...
        <p>The story really began in the middle sixties, the period of the great
        ...
        <p>Some time after their release Winston had actually seen all three of them
        ...
        <p>There was no one at any of the tables nearest to them. It was not wise
        ...
        <p>It was the lonely hour of fifteen. Winston could not now remember how he
        ...
        <p>The three men never stirred. But when Winston glanced again at Rutherford's
        ...
        <p>A little later all three were re-arrested. It appeared that they had
        ...
        <p>The point was that at both trials all three men had confessed that on that
        ...
        <p>Of course, this was not in itself a discovery. Even at that time Winston
        ...
        <p>He had gone straight on working. As soon as he saw what the photograph
        ...
        <p>He took his scribbling pad on his knee and pushed back his chair so as
        ...
        <p>That was ten--eleven years ago. Today, probably, he would have kept that
        ...
        <p>But today, supposing that it could be somehow resurrected from its ashes,
        ...
        <p>He wondered, as he had many times wondered before, whether he himself was
        ...
        <p>He picked up the children's history book and looked at the portrait of
          ...
          two and two made five, and you would have to believe it. It was <span
            class="tooltip"><strong>inevitable</strong><span class="tooltiptext">Certain to happen;
              unavoidable</span></span>
        ...
        <p>But no! His courage seemed suddenly to stiffen of its own accord. The face
          ...
          <span class="tooltip"><strong>interminable</strong><span class="tooltiptext">Endless (often used
              hyperbolically)</span></span> letter which no one would ever read, but which was addressed
          to a particular person and took its colour from that fact.
        </p>

        <p>The Party told you to reject the evidence of your eyes and ears. It was
        ...
        <p>Freedom is the freedom to say that two plus two make four. If that is
      ...
      <div id="chapter-8" class="chapter-section">
        ...
        <p>From somewhere at the bottom of a passage the smell of roasting
        ...
        <p>He had walked several kilometres over pavements, and his varicose ulcer
        ...
        <p>'If there is hope,' he had written in the diary, 'it lies in the proles.'
          The words kept coming back to him, statement of a mystical truth and a
          <span class="tooltip"><strong>palpable</strong><span class="tooltiptext">Able to be touched or
              felt</span></span> absurdity. He was somewhere in the vague, brown-coloured slums
        ...
        <p>'"Yes," I says to 'er, "that's all very well," I says. "But if you'd of
        ...
        <p>The strident voices stopped abruptly. The women studied him in hostile
        ...
        <p>Suddenly the whole street was in commotion. There were yells of warning
        ...
        <p>'Steamer' was a nickname which, for some reason, the proles applied to
        ...
        <p>He walked on. The bomb had demolished a group of houses 200 metres up the
        ...
        <p>He kicked the thing into the gutter, and then, to avoid the crowd, turned
          down a side-street to the right. Within three or four minutes he was out
          of the area which the bomb had affected, and the <span class="tooltip"><strong>sordid</strong><span
              class="tooltiptext">Involving ignoble actions and motives; arousing moral distaste and
              contempt</span></span> swarming life of
        ...
        <p>'Can't you bleeding well listen to what I say? I tell you no number ending
          in seven ain't won for over fourteen months!'</p>

        <p>'Yes, it 'as, then!'</p>

        <p>'No, it 'as not! Back 'ome I got the 'ole lot of 'em for over two years
          wrote down on a piece of paper. I takes 'em down reg'lar as the clock. An'
          I tell you, no number ending in seven----'</p>

        <p>'Yes, a seven 'AS won! I could pretty near tell you the bleeding number.
          Four oh seven, it ended in. It were in February--second week in February.'</p>

        <p>'February your grandmother! I got it all down in black and white. An' I
          tell you, no number----'</p>

        <p>'Oh, pack it in!' said the third man.</p>

        <p>They were talking about the Lottery. Winston looked back when he had gone
          thirty metres. They were still arguing, with <span class="tooltip"><strong>vivid</strong><span
              class="tooltiptext">Producing powerful feelings or strong, clear images in the mind</span></span>,
          passionate faces.
        ...
        <p>But if there was hope, it lay in the proles. You had to cling on to that.
        ...
        <p>He paused for a moment at the top of the steps. On the opposite side of
        ...
        <p>Hurriedly, lest he should have time to become frightened, he descended the
        ...
        <p>'I arst you civil enough, didn't I?' said the old man, straightening his
          shoulders pugnaciously. 'You telling me you ain't got a pint mug in the
          'ole bleeding boozer?'</p>

        <p>'And what in hell's name IS a pint?' said the barman, leaning forward with
          the tips of his fingers on the counter.</p>

        <p>''Ark at 'im! Calls 'isself a barman and don't know what a pint is! Why,
          a pint's the 'alf of a quart, and there's four quarts to the gallon.
          'Ave to teach you the A, B, C next.'</p>

        <p>'Never heard of 'em,' said the barman shortly. 'Litre and half
          litre--that's all we serve. There's the glasses on the shelf in front
          of you.'</p>

        <p>'I likes a pint,' persisted the old man. 'You could 'a drawed me off a pint
          easy enough. We didn't 'ave these bleeding litres when I was a young man.'</p>

        <p>'When you were a young man we were all living in the treetops,' said the
          barman, with a glance at the other customers.</p>

        <p>There was a shout of laughter, and the uneasiness caused by Winston's entry
        ...
        <p>'You're a gent,' said the other, straightening his shoulders again. He
          appeared not to have noticed Winston's blue overalls. 'Pint!' he added
          aggressively to the barman. 'Pint of wallop.'</p>

        <p>The barman swished two half-litres of dark-brown beer into thick glasses
        ...
        <p>''E could 'a drawed me off a pint,' grumbled the old man as he settled down
        ...
        <p>'You must have seen great changes since you were a young man,' said
          Winston tentatively.</p>

        <p>The old man's pale blue eyes moved from the darts board to the bar, and
          from the bar to the door of the Gents, as though it were in the bar-room
          that he expected the changes to have occurred.</p>

        <p>'The beer was better,' he said finally. 'And cheaper! When I was a young
        ...
        <p>'It's all wars,' said the old man vaguely. He took up his glass, and his
          shoulders straightened again. ''Ere's wishing you the very best of 'ealth!'</p>

        <p>In his lean throat the sharp-pointed Adam's apple made a surprisingly rapid
        ...
        <p>'You are very much older than I am,' said Winston. 'You must have been a
        ...
        <p>'Top 'ats!' he said. 'Funny you should mention 'em. The same thing come
        ...
        <p>'It isn't very important about the top hats,' said Winston patiently.
        ...
        <p>'Lackeys!' he said. 'Now there's a word I ain't 'eard since ever so long.
        ...
        <p>'What I really wanted to know was this,' he said. 'Do you feel that you
        ...
        <p>'The House of Lords, if you like. What I am asking is, were these people
        ...
        <p>The old man appeared to think deeply. He drank off about a quarter of his
          beer before answering.</p>

        <p>'Yes,' he said. 'They liked you to touch your cap to 'em. It showed
          respect, like. I didn't agree with it, myself, but I done it often enough.
          Had to, as you might say.'</p>

        <p>'And was it usual--I'm only quoting what I've read in history books--was
          it usual for these people and their servants to push you off the pavement
          into the gutter?'</p>

        <p>'One of 'em pushed me once,' said the old man. 'I recollect it as if it
        ...
        <p>A sense of helplessness took hold of Winston. The old man's memory was
        ...
        <p>'Perhaps I have not made myself clear,' he said. 'What I'm trying to say
        ...
        <p>The old man looked meditatively at the darts board. He finished up his
          beer, more slowly than before. When he spoke it was with a tolerant
          philosophical air, as though the beer had mellowed him.</p>

        <p>'I know what you expect me to say,' he said. 'You expect me to say as I'd
        ...
        <p>Winston sat back against the window-sill. It was no use going on. He was
        ...
        <p>At this moment his train of thought stopped abruptly. He halted and looked
        ...
        <p>A twinge of fear went through him. It had been a sufficiently rash act to
        ...
        <p>The proprietor had just lighted a hanging oil lamp which gave off an
        ...
        <p>'I recognized you on the pavement,' he said immediately. 'You're the
        ...
        <p>'I was passing,' said Winston vaguely. 'I just looked in. I don't want
          anything in particular.'</p>

        <p>'It's just as well,' said the other, 'because I don't suppose I could have
        ...
        <p>The tiny interior of the shop was in fact uncomfortably full, but there
        ...
        <p>It was a heavy lump of glass, curved on one side, flat on the other, making
        ...
        <p>'That's coral, that is,' said the old man. 'It must have come from the
        ...
        <p>'It is a beautiful thing,' said the other appreciatively. 'But there's not
        ...
        <p>Winston immediately paid over the four dollars and slid the coveted thing
          ...
          <span class="tooltip"><strong>apparent</strong><span class="tooltiptext">Clearly visible or understood;
              obvious</span></span> uselessness, though he could guess that it must once have been
        ...
        <p>'There's another room upstairs that you might care to take a look at,' he
          said. 'There's not much in it. Just a few pieces. We'll do with a light if
          we're going upstairs.'</p>

        <p>He lit another lamp, and, with bowed back, led the way slowly up the
        ...
        <p>'We lived here till my wife died,' said the old man half apologetically.
        ...
        <p>He was holding the lamp high up, so as to illuminate the whole room, and
          ...
          the room had awakened in him a sort of <span class="tooltip"><strong>nostalgia</strong><span
              class="tooltiptext">A sentimental longing or wistful affection for the past</span></span>, a sort of
          ancestral
        ...
        <p>'Ah,' said the old man, 'I never had one of those things. Too expensive.
        ...
        <p>There was a small bookcase in the other corner, and Winston had already
        ...
        <p>'Now, if you happen to be interested in old prints at all----' he began
          delicately.</p>

        <p>Winston came across to examine the picture. It was a steel engraving of an
        ...
        <p>'The frame's fixed to the wall,' said the old man, 'but I could unscrew it
          for you, I dare say.'</p>

        <p>'I know that building,' said Winston finally. 'It's a ruin now. It's in
          the middle of the street outside the Palace of Justice.'</p>

        <p>'That's right. Outside the Law Courts. It was bombed in--oh, many years
        ...
        <p>'Oh--"Oranges and lemons, say the bells of St Clement's." That was a rhyme
        ...
        <p>Winston wondered vaguely to what century the church belonged. It was always
        ...
        <p>'There's a lot of them left, really,' said the old man, 'though they've
        ...
        <p>there, now, that's as far as I can get. A farthing, that was a small copper
          coin, looked something like a cent.'</p>

        <p>'Where was St Martin's?' said Winston.</p>

        <p>'St Martin's? That's still standing. It's in Victory Square, alongside the
          picture gallery. A building with a kind of a triangular porch and pillars
          in front, and a big flight of steps.'</p>

        <p>Winston knew the place well. It was a museum used for <span class="tooltip"><strong>propaganda</strong><span
              class="tooltiptext">Information, especially of a biased or misleading nature, used to promote or publicize
              a particular political cause or point of view</span></span> displays
        ...
        <p>'St Martin's-in-the-Fields it used to be called,' supplemented the old man,
          'though I don't recollect any fields anywhere in those parts.'</p>

        <p>Winston did not buy the picture. It would have been an even more
        ...
        <p>He got away from Mr Charrington and went down the stairs alone, so as not
        ...
        <p>Yes, he thought again, he would come back. He would buy further scraps of
        ...
        <p>Suddenly his heart seemed to turn to ice and his bowels to water. A figure
        ...
        <p>For a few seconds Winston was too paralysed to move. Then he turned to the
        ...
        <p>It was an effort to walk. The lump of glass in his pocket banged against
        ...
        <p>The street was a blind alley. Winston halted, stood for several seconds
        ...
        <p>It was after twenty-two hours when he got back to the flat. The lights
        ...
        <p>It was at night that they came for you, always at night. The proper thing
        ...
        <p>He opened the diary. It was important to write something down. The woman
        ...
        <p>Why did you have to endure it, since the end was always the same? Why was
        ...
        <p>He tried with a little more success than before to summon up the image of
      ...
      <!-- Chapter 23 -->
      <div id="chapter-23" class="chapter-section">
        <div class="chapter-title text-3xl font-bold text-center mb-8 text-primary">Chapter 23</div>
        <p>
      ...
      <!-- Chapter 24 -->
      <div id="chapter-24" class="chapter-section">
        <div class="chapter-title text-3xl font-bold text-center mb-8 text-primary">Chapter 24</div>
        <p>
      ...
      <!-- Chapter 25 -->
      <div id="chapter-25" class="chapter-section">
        <div class="chapter-title text-3xl font-bold text-center mb-8 text-primary">APPENDIX.</div>
        <p>
          APPENDIX.
