 ...
 * This file contains the curriculum data for all grade levels.
...
const learningLevels = [
     ...
     * Hesten's Learning - Grade Level Data
     * This file contains the curriculum data for all grade levels.
     * Categorized by: elem (Elementary) Pre-K
     */
    {
        "id": "pre-k",
        "category": "elem",
     ...
     * Hesten's Learning - Grade Level Data
     * This file contains the curriculum data for all grade levels.
     * Categorized by: elem (Elementary) Kindergarden
     */
    {
        "id": "kindergarten",
        "category": "elem",
     ...
     * Hesten's Learning - Grade Level Data
     * This file contains the curriculum data for all grade levels.
     * Categorized by: elem (Elementary) 1st
     */
    {
        "id": "grade-1",
        "category": "elem",
     ...
     * Hesten's Learning - Grade Level Data
     * This file contains the curriculum data for all grade levels.
     * Categorized by: elem (Elementary) 2nd
     */
    {
        "id": "grade-2",
        "category": "elem",
     ...
     * Hesten's Learning - Grade Level Data
     * This file contains the curriculum data for all grade levels.
     * Categorized by: elem (Elementary) 3rd
     */
    {
        "id": "grade-3",
        "category": "elem",
     ...
     * Hesten's Learning - Grade Level Data
     * This file contains the curriculum data for all grade levels.
     * Categorized by: elem (Elementary) 4th
     */
    {
        "id": "grade-4",
        "category": "elem",
     ...
     * Hesten's Learning - Grade Level Data
     * This file contains the curriculum data for all grade levels.
     * Categorized by: elem (Elementary) 5th
     */
    {
        "id": "grade-5",
        "category": "elem",
     ...
     * Hesten's Learning - Grade Level Data
     * This file contains the curriculum data for all grade levels.
     * Categorized by: middle (Middle School) 6th
     */
    {
        "id": "grade-6",
        "category": "middle",
     ...
     * Hesten's Learning - Grade Level Data
     * This file contains the curriculum data for all grade levels.
     * Categorized by: middle (Middle School) 7th
     */
    {
        "id": "grade-7",
        "category": "middle",
     ...
     * Hesten's Learning - Grade Level Data
     * This file contains the curriculum data for all grade levels.
     * Categorized by: middle (Middle School) 8th
     */
    {
        "id": "grade-8",
        "category": "middle",
        ...
        "link": "levels/j.php",
        "icon": "fas fa-history",
        "documentation": "<h4 class=\"text-xl font-bold mb-4\">Core Subjects & Standards</h4><div class=\"space-y-4\"><div><h5 class=\"text-lg font-bold text-primary mb-1\">Math</h5><p class=\"text-text-secondary\">Pre-Algebra/Algebra 1, linear equations, Pythagorean Theorem.<br><span class=\"text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">CCSS.MATH.CONTENT.8.EE.B.5</span></p></div><div><h5 class=\"text-lg font-bold text-primary mb-1\">ELA</h5><p class=\"text-text-secondary\">Literary theory, comprehensive research papers, classical literature.<br><span class=\"text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">CCSS.ELA-LITERACY.RL.8.1</span></p></div><div><h5 class=\"text-lg font-bold text-primary mb-1\">Science</h5><p class=\"text-text-secondary\">Physical sciences (chemistry/physics intro), matter interactions.<br><span class=\"text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">NGSS: MS-PS1-2</span></p></div><div><h5 class=\"text-lg font-bold text-primary mb-1\">Social Studies</h5><p class=\"text-text-secondary\">U.S. History (Constitution through Reconstruction), civic documents.<br><span class=\"text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">NCSS.D2.His.4.6-8</span></p></div></div>"
    },

    /**
     * Hesten's Learning - Grade Level Data
     * This file contains the curriculum data for all grade levels.
     * Categorized by: high (High School) 9th
     */
    {
        "id": "grade-9",
        "category": "high",
        ...
        "keywords": "ninth grade, freshman, algebra 1, functions, polynomials, equations, statistics, histograms, scatter plots, 9th",
        "link": "levels/k.php",
        "icon": "fas fa-flask",
        "documentation": "<h4 class=\"text-xl font-bold mb-4\">Core Subjects & Standards</h4><div class=\"space-y-4\"><div><h5 class=\"text-lg font-bold text-primary mb-1\">Math</h5><h4 class=\"text-lg font-semibold text-primary mb-2\">Math: Algebra I - Module 1</h4><p class=\"text-text-secondary mb-3\">Module 1 focuses on Relationships Between Quantities and Reasoning with Equations and Their Graphs. This module sets the foundation for high school algebra.</p><div class=\"space-y-3 pl-4 border-l-2 border-blue-500 dark:border-blue-400\"><div><h6 class=\"font-semibold text-text-primary\">Topic A: Introduction to Functions</h6><p class=\"text-sm text-text-secondary\">Students explore graphing stories, including piecewise linear functions, quadratic functions, and exponential functions. They learn to analyze graphs representing real world scenarios like elevation versus time and water usage.</p><span class=\"text-xs font-semibold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">N-Q.A.1, N-Q.A.2, N-Q.A.3, A-CED.A.2</span></div><div><h6 class=\"font-semibold text-text-primary\">Topic B: The Structure of Expressions</h6><p class=\"text-sm text-text-secondary\">Focuses on algebraic expressions, applying the distributive, commutative, and associative properties. Students master adding, subtracting, and multiplying polynomials.</p><span class=\"text-xs font-semibold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">A-SSE.A.2, A-APR.A.1</span></div><div><h6 class=\"font-semibold text-text-primary\">Topic C & Beyond: Equations and Inequalities</h6><p class=\"text-sm text-text-secondary\">Students learn to solve complex equations, inequalities, and systems of equations, applying them to real world word problems like calculating ticket sale combinations and income tax rates.</p><span class=\"text-xs font-semibold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">A-CED.A.3, A-REI.C.6</span></div> </div><div class=\"mt-8 pt-6 border-t border-gray-100 dark:border-gray-800\"><h4 class=\"text-lg font-semibold text-primary mb-2\">Mathematics: Algebra I - Module 2</h4><p class=\"text-text-secondary mb-3\">Module 2 dives into Descriptive Statistics, helping students summarize, represent, and interpret data on a single count or measurement variable as well as data on two categorical and quantitative variables.</p><div class=\"space-y-3 pl-4 border-l-2 border-green-500 dark:border-green-400\"><div><h6 class=\"font-semibold text-text-primary\">Topics A & B: Shapes, Centers, and Variability</h6><p class=\"text-sm text-text-secondary\">Students explore data distributions using dot plots and histograms. They calculate the center and spread of data using mean, median, standard deviation, and interquartile range to compare different data sets.</p><span class=\"text-xs font-semibold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">S-ID.A.1, S-ID.A.2, S-ID.A.3</span></div><div><h6 class=\"font-semibold text-text-primary\">Topic C: Categorical Data on Two Variables</h6><p class=\"text-sm text-text-secondary\">Focuses on summarizing bivariate categorical data using two way frequency tables and calculating Music conditional relative frequencies to find associations.</p><span class=\"text-xs font-semibold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">S-ID.B.5, S-ID.C.9</span></div><div><h6 class=\"font-semibold text-text-primary\">Topic D: Numerical Data on Two Variables</h6><p class=\"text-sm text-text-secondary\">Students create scatter plots, fit linear models to data, and analyze residual plots to evaluate how well a model fits the data. They also explore correlation and causation.</p><span class=\"text-xs font-semibold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">S-ID.B.6, S-ID.C.7</span></div></div></div><div class=\"mt-8 pt-6 border-t border-gray-100 dark:border-gray-800\"><h4 class=\"text-lg font-semibold text-primary mb-2\">Mathematics: Algebra I - Module 3: Linear and Exponential Functions</h4><div class=\"space-y-3 pl-4 border-l-2 border-purple-500 dark:border-purple-400\"><div><h6 class=\"font-semibold text-text-primary\">Linear and Exponential Sequences</h6><p class=\"text-sm text-text-secondary\">Understanding integer sequences, recursive and explicit formulas, and the difference between arithmetic and geometric patterns.</p><span class=\"text-xs font-semibold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">F-IF.A.3, F-BF.A.1a, F-LE.A.2</span></div><div><h6 class=\"font-semibold text-text-primary\">Exponential Growth & Decay</h6><p class=\"text-sm text-text-secondary\">Modeling real-world scenarios like population growth and compound interest using exponential functions.</p><span class=\"text-xs font-semibold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">F-LE.A.1, F-LE.A.3</span></div><div><h6 class=\"font-semibold text-text-primary\">Functions and Their Graphs</h6><p class=\"text-sm text-text-secondary\">Evaluating functions, interpreting domain and range, and analyzing transformations of graphs including piecewise and step functions.</p><span class=\"text-xs font-semibold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">F-IF.A.1, F-IF.B.4, F-IF.C.7</span></div></div></div><div class=\"mt-8 pt-6 border-t border-gray-100 dark:border-gray-800\"><h4 class=\"text-lg font-semibold text-primary mb-2\">Mathematics: Algebra I - Module 4: Polynomial and Quadratic Expressions, Equations, and Functions</h4><div class=\"space-y-3 pl-4 border-l-2 border-orange-500 dark:border-orange-400\"><div><h6 class=\"font-semibold text-text-primary\">Multiplying and Factoring Polynomials</h6><p class=\"text-sm text-text-secondary\">Mastering greatest common factor (GCF), trinomial factoring, and advanced strategies for quadratic expressions.</p><span class=\"text-xs font-semibold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">A-SSE.A.2, A-APR.A.1</span></div><div><h6 class=\"font-semibold text-text-primary\">Solving Quadratic Equations</h6><p class=\"text-sm text-text-secondary\">Using the zero product property, completing the square, and the quadratic formula to find roots in real world contexts.</p><span class=\"text-xs font-semibold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">A-REI.B.4b, A-CED.A.1</span></div><div><h6 class=\"font-semibold text-text-primary\">Graphing and Modeling Quadratics</h6><p class=\"text-sm text-text-secondary\">Analyzing key features of parabolas such as symmetry, vertices, and intercepts, while modeling projectile motion like free fall.</p><span class=\"text-xs font-semibold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">F-IF.C.7a, F-IF.B.4</span></div></div></div><div class=\"mt-8 pt-6 border-t border-gray-100 dark:border-gray-800\"><h4 class=\"text-lg font-semibold text-primary mb-2\">Mathematics: Algebra I - Module 5: A Synthesis of Modeling with Equations and Functions</h4><div class=\"space-y-3 pl-4 border-l-2 border-red-500 dark:border-red-400\"><div><h6 class=\"font-semibold text-text-primary\">Elements of Modeling</h6><p class=\"text-sm text-text-secondary\">Analyzing graphs, data sets, and verbal descriptions to identify key features and select appropriate linear, quadratic, or exponential models.</p><span class=\"text-xs font-semibold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">N-Q.A.2, F-LE.A.1</span></div><div><h6 class=\"font-semibold text-text-primary\">The Modeling Cycle</h6><p class=\"text-sm text-text-secondary\">Moving from context to equations by identifying variables, formulating models, and interpreting solutions within real-world constraints.</p><span class=\"text-xs font-semibold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">A-CED.A.2, F-BF.A.1a</span></div><div><h6 class=\"font-semibold text-text-primary\">Comparing Function Types</h6><p class=\"text-sm text-text-secondary\">Evaluating the growth rates and behaviors of different functions, such as comparing exponential growth to linear or quadratic models over time.</p><span class=\"text-xs font-semibold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">F-IF.B.6, F-LE.A.3</span></div></div></div><p class=\"text-xs text-gray-500/70 mt-6 pt-4 border-t border-gray-100 dark:border-white/5 italic\">Note: The mathematics curriculum is sourced from EngageNY.</p></div><div><h5 class=\"text-lg font-bold text-primary mb-1\">ELA</h5><p class=\"text-text-secondary\">Literary theory, comprehensive research papers, classical literature.<br><span class=\"text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">CCSS.ELA-LITERACY.RL.8.1</span></p></div><div><h5 class=\"text-lg font-bold text-primary mb-1\">Science</h5><p class=\"text-text-secondary\">Physical sciences (chemistry/physics intro), matter interactions.<br><span class=\"text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">NGSS: MS-PS1-2</span></p></div><div><h5 class=\"text-lg font-bold text-primary mb-1\">Social Studies</h5><p class=\"text-text-secondary\">U.S. History (Constitution through Reconstruction), civic documents.<br><span class=\"text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200    dark:border-gray-700\">NCSS.D2.His.4.6-8</span></p></div></div>"
    },

    /**
     * Hesten's Learning - Grade Level Data
     * This file contains the curriculum data for all grade levels.
     * Categorized by: high (High School) 10th
     */
    {
        "id": "grade-10",
        "category": "high",
     ...
     * Hesten's Learning - Grade Level Data
     * This file contains the curriculum data for all grade levels.
     * Categorized by: high (High School) 11th
     */
    {
        "id": "grade-11",
        "category": "high",
     ...
     * Hesten's Learning - Grade Level Data
     * This file contains the curriculum data for all grade levels.
     * Categorized by: high (High School) 12th
     */
    {
        "id": "grade-12",
        "category": "high",
    ...
    /**
     * Hesten's Learning - Grade Level Data
     * Test / Extra Resources Tile (Shown after Grade 12)
     */
    {
        "id": "test-section",
        "category": "extra",
    ...
    /**
     * Hesten's Learning - Grade Level Data
     * AP U.S. History Resource Tile
     * Categorized by: extra (Resources)
     */
    {
        "id": "ap-us-history",
        "category": "extra",
        "title": "AP US History",
        "description": "College-level U.S. history curriculum covering 9 chronological periods, document-based analysis, and historical reasoning skills.",
        "keywords": "ap, apush, history, united states, american history, dbq, college prep",
        "link": "levels/ap-us-history.php",
        "icon": "fas fa-landmark",
        "documentation": "<h4 class=\"text-xl font-bold mb-4\">AP U.S. History Curriculum Overview</h4><div class=\"space-y-4\"><div><h5 class=\"text-lg font-bold text-primary mb-1\">Early & Colonial America (1491–1754)</h5><p class=\"text-text-secondary\">Pre-Columbian societies, European exploration, transatlantic trade, and colonial regional development.<br><span class=\"text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">AP Period 1 & 2</span></p></div><div><h5 class=\"text-lg font-bold text-primary mb-1\">Revolution & Expansion (1754–1848)</h5><p class=\"text-text-secondary\">The American Revolution, Constitutional development, Jacksonian democracy, and Westward Expansion.<br><span class=\"text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">AP Period 3 & 4</span></p></div><div><h5 class=\"text-lg font-bold text-primary mb-1\">Civil War & Industrialization (1844–1914)</h5><p class=\"text-text-secondary\">Sectional conflict, Civil War, Reconstruction era, Gilded Age industrial growth, and Immigration.<br><span class=\"text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">AP Period 5 & 6</span></p></div><div><h5 class=\"text-lg font-bold text-primary mb-1\">Modern Era & Global Power (1890–Present)</h5><p class=\"text-text-secondary\">Progressivism, World Wars, Great Depression, Cold War, Civil Rights Movement, and Contemporary America.<br><span class=\"text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">AP Period 7, 8 & 9</span></p></div></div>"
    },

    /**
     * Hesten's Learning - Grade Level Data
     * American Yawp Resource Tile
     * Categorized by: extra (Resources)
     */
    {
        "id": "american-yawp",
        "category": "extra",
        "title": "American Yawp",
        "description": "Collaborative, open-source U.S. history textbook featuring comprehensive narratives and primary source reader documents.",
        "keywords": "american yawp, yawp, history, primary sources, textbook, open educational resource, social studies",
        "link": "levels/american-yawp.php",
        "icon": "fas fa-book-reader",
        "documentation": "<h4 class=\"text-xl font-bold mb-4\">The American Yawp Reader & Course</h4><div class=\"space-y-4\"><div><h5 class=\"text-lg font-bold text-primary mb-1\">Volume 1: Before 1877</h5><p class=\"text-text-secondary\">Indigenous America, New World encounters, Colonial society, American Revolution, Cotton Kingdom, and Civil War.<br><span class=\"text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">Open Textbook Vol I</span></p></div><div><h5 class=\"text-lg font-bold text-primary mb-1\">Volume 2: After 1877</h5><p class=\"text-text-secondary\">Capital & Labor, Industrial America, World War I & II, The Affluent Society, The Sixties, and the triumph of the Right.<br><span class=\"text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">Open Textbook Vol II</span></p></div><div><h5 class=\"text-lg font-bold text-primary mb-1\">Primary Source Reader</h5><p class=\"text-text-secondary\">Historical speeches, letters, photographs, legislative acts, and firsthand accounts for evidence-based analysis.<br><span class=\"text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">Primary Source Documents</span></p></div></div>"
    },

    /**
     * Hesten's Learning - Grade Level Data
     * Practice GED Resource Tile
     * Categorized by: extra (Resources)
     */
    {
        "id": "practice-ged",
        "category": "extra",
        "title": "Practice GED",
        "description": "Comprehensive prep for the GED equivalency test covering Math Reasoning, Language Arts, Science, and Social Studies.",
        "keywords": "ged, high school equivalency, practice test, test prep, math, rla, science, social studies",
        "link": "levels/practice-ged.php",
        "icon": "fas fa-user-graduate",
        "documentation": "<h4 class=\"text-xl font-bold mb-4\">GED Test Modules & Practice</h4><div class=\"space-y-4\"><div><h5 class=\"text-lg font-bold text-primary mb-1\">Mathematical Reasoning</h5><p class=\"text-text-secondary\">Algebraic equations, linear functions, geometry basics, word problems, graphs, and numeric operations.<br><span class=\"text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">GED Math Standard</span></p></div><div><h5 class=\"text-lg font-bold text-primary mb-1\">Reasoning Through Language Arts</h5><p class=\"text-text-secondary\">Reading comprehension, informational text analysis, sentence structure, grammar, and extended response writing.<br><span class=\"text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">GED RLA Standard</span></p></div><div><h5 class=\"text-lg font-bold text-primary mb-1\">Science & Social Studies</h5><p class=\"text-text-secondary\">Life & physical science concepts, scientific method, U.S. history, civics, economics, and data interpretation.<br><span class=\"text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700\">GED Science & Social</span></p></div></div>"
    }
];
